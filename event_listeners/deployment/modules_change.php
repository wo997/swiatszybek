...
$out .= "];";
Files::save(BUILDS_PATH . "link_module_path.php", $out);
...
$out .= "];";
Files::save(BUILDS_PATH . "link_module_block_php_path.php", $out);
...
$out .= "];";
Files::save(BUILDS_PATH . "link_module_block_form_path.php", $out);
...
$out .= "];";
Files::save(BUILDS_PATH . "link_module_form_path.php", $out);
