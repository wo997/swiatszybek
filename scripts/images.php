...
// share_img
define("SHARE_IMG_PATH_LOCAL", "/" . setting(["theme", "copied_images", "share_img", "path"], ""));
$share_img_file_path = getResponsiveImageBySize(SHARE_IMG_PATH_LOCAL, $image_default_dimensions["sm"], ["same-ext" => true]);
$share_img_file_path .= "?v=" . setting(["theme", "copied_images", "share_img", "version"], "");
