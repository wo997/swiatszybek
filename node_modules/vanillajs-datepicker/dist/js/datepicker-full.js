(function () {
	...
	function processOptions(options, datepicker) {
		...
		let { format, language, locale, maxDate, maxView, minDate, startView, weekStart } = datepicker.config || {};
  ...
  <div class="weeks">${createTagRepeat("span", 6, { class: "week" })}</div>
	...
	function goToSelectedMonthOrYear(datepicker, selection) {
		...
		const newDate =
			viewId === 1 ? addMonths(viewDate, selection - viewDate.getMonth()) : addYears(viewDate, selection - viewDate.getFullYear());
