window.addEventListener("DOMContentLoaded", () => {
    if (window.innerWidth < 800) {
        var nv = elem(".navbar_wrapper");
        if (!nv) return;
        nv.classList.add("expandY");
        nv.classList.add("hidden");
        nv.insertAdjacentHTML("beforebegin",`
            <div class="btn secondary fill medium" onclick='expandWithArrow(this.nextElementSibling,this.querySelector(".expand"))'>
