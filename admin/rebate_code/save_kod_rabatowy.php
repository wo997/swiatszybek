...
if ($submit == "save")
{
  query("INSERT INTO kody_rabatowe (kod, kwota, user_id_list, product_id_list, product_list_metadata, date_from, date_to, ilosc, type) VALUES (?,?,?,?,?,?,?,?,?)",
