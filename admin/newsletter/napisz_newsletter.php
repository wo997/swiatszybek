...
<script src="https://unpkg.com/computed-style-to-inline-style"></script>
    ...
    <script>
            ...
            xhr.onload = function() {
                if (xhr.status == 200) {
                    try {
                        ...
                        var out = "";
                        var replaceImg = document.querySelector(".replaceThatImagePlease");
        ...
        function formValidate() {
            document.querySelectorAll("#editor .ql-editor *").forEach((e)=>{
            ...
            document.getElementById("description").value = document.querySelector(".quill-1 .ql-editor").innerHTML;

            return validateForm({form:elem("#mainForm")});
    ...
    <form class="default-form" id="mainForm" action="/admin/send_newsletter" method="post" onsubmit="return formValidate()">
            ...
            <div id="editor" class="quill-wrapper quill-1">
                ...
                <script>
                    ...
                    document.querySelector(".quill-1 .ql-image").outerHTML += "";
                    setTimeout(function() {
                        document.querySelector(".quill-1 .ql-image").onclick = function() {
                            imagePicker('quill')
                        };
                    }, 100);

                    document.querySelector(".quill-1 .ql-toolbar").insertAdjacentHTML("beforeend", `
            ...
            `);
                    ...
                    document.querySelector(".quill-1 .ql-toolbar").insertAdjacentHTML("afterbegin", `
            ...
            `);
                    ...
                    document.querySelector('#run-fullscreen').addEventListener('click', function() {
                        var res = document.querySelector(".quill-wrapper").classList.toggle("ql-fullscreen");
                        document.querySelector("html").style.overflow = res ? "hidden" : "";
                    });
                    ...
                    quill.on('text-change', function(delta, oldDelta, source) {
                        ...
                        document.querySelectorAll("#description-quill .ql-editor img").forEach((e) => {
                        ...
                        document.querySelector(".quill-1 .ql-editor").scrollLeft = 0;

                        if (document.querySelector("#description-quill .ql-editor").innerHTML.indexOf('<div class="quill-better') === 0) {
                            document.querySelector(".quill-1 .ql-editor").insertAdjacentHTML("afterbegin", "<p class='detected'><br></p>");
                        }
                        ...
                        document.querySelectorAll("span div.spanblock").forEach((e) => {
                            e.parentNode.classList.add("wrap-spanblock")
                        });
                        document.querySelectorAll(".wrap-spanblock .spanblock").forEach((e) => {
                            e.outerHTML = e.innerHTML
                        });
                        document.querySelectorAll(".wrap-spanblock").forEach((e) => {
                    ...
                    document.getElementById("editor").addEventListener("scroll", function(e) {
                        ...
                        var diff = wasY - nowY;
                        var m = document.querySelector(".qlbt-operation-menu");
                        if (m) {
                    ...
                    document.querySelector(".quill-1 .ql-editor").addEventListener("click", (e) => {
                        ...
                        if (e.target.tagName == "IMG") {
                            menu_sub = 'img';
                            document.querySelector(".image-buttons").style.display = "block";
                    ...
                    function historyBack(callback) {
                        if (quillHistory.length >= 2) {
                            ...
                            document.querySelector(".quill-1 .ql-editor").innerHTML = c[0];
                    ...
                    function pushHistoryState() {
                        if (ignoreChange) return;
                        quillHistory.push([document.querySelector(".quill-1 .ql-editor").innerHTML, quill.getSelection()]);
                        if (quillHistory.length < 2) {
                            quillHistory.push([document.querySelector(".quill-1 .ql-editor").innerHTML, quill.getSelection()]);
                        }
                    ...
                    document.querySelector(".quill-1 .ql-editor").addEventListener("keydown", function(e) {
                            ...
                            if (elem) {
                                while (true) {
                                    ...
                                    if (elem.tagName == "TABLE") {
                                        ...
                                        for (i = 0; i < 3; i++) {
                                            var e = document.querySelector(".res" + i);
                                            if (!e) continue;
                    ...
                    var observer = new MutationObserver(() => {
                        ...
                        var tool = document.querySelector('.qlbt-col-tool:not(.changed)');
                        if (!tool) return;
                ...
                `; //<button title="Szara tabelka" type="button" style="width:auto" id="make-table-gray"><div style="border: 1px solid black;width: 14px;height: 14px;background:#888"></div></button>`;
                    ...
                    observer.observe(document.querySelector('.quill-1'), config);

                    var spanBlockButton = document.querySelector('.ql-spanblock');

                    var des = `<?= str_replace(["\`", "`"], ["`", "\`"], $description) ?>`;

                    document.querySelector(".quill-1 .ql-editor").innerHTML = des; // necessary
                </script>
            </div>
