        ...
        createDatatable({
            ...
            definition: [{
                ...
                },
                {
                    ...
                    render: (r, i, t) => {
                        return `
                            <div class="btn admin-secondary" onclick="editAttribute(this,${i},${t.name})">Edytuj <i class="fa fa-cog"></i></div>
                        `;
                    },
                    escape: false
                }
            ...
            controls: `
                    ...
                    <div class="btn admin-primary" onclick="editAttribute(this)"><span>Dodaj atrybut</span> <i class="fa fa-plus"></i></div>
                `
        });
...
<div id="editAttribute" data-modal data-expand data-exclude-hidden>
    <div class="modal-body stretch-vertical">
        <div class="custom-toolbar">
            ...
            <button class="btn admin-primary" onclick="saveAttribute();">Zapisz <i class="fa fa-save"></i></button>
        </div>
        <div class="modal-body stretch-vertical">
            <div class="desktopRow spaceColumns">
                ...
                <div>
                    <div class="field-title">Wyświetl filtry w kategoriach <a href="/admin/kategorie" target="_blank" class="btn admin-secondary" onclick="editAttribute()"><span>Zarządzaj</span> <i class="fa fa-cog"></i></a></div>
            ...
            <div style="margin-top:auto; align-self: flex-end; padding-top:30px; margin-bottom:10px">
                <button class="btn admin-red" onclick="if(confirm('Czy aby na pewno chcesz usunąć ten atrybut?')) saveAttribute(true);">Usuń <i class="fa fa-times"></i></button>
            </div>
