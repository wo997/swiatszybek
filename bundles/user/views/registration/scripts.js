	...
	xhr({
		...
		success: (res) => {
			...
			if (res == "exists") {
				...
				errors.push(
					"<span style='color: black'>Konto istnieje <b style='color:var(--success-clr);display: inline-block;' class='link' onclick='register(false)'>WYŚLIJ LINK AKTYWACYJNY</b></span>"
				);
			} else if (res == "invalid") {
