...
Request::jsonResponse(paginateData([
    "select" => "p.page_id, p.seo_title, p.seo_description, DATE_FORMAT(p.created_at, '%d-%m-%Y %H:%i') created_at, DATE_FORMAT(p.modified_at, '%d-%m-%Y %H:%i') modified_at, gp.name, p.template_id, gp.__url, p.active",
