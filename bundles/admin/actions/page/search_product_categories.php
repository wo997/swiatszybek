...
Request::jsonResponse(paginateData([
    "select" => "p.page_id, p.seo_title, p.seo_description, DATE_FORMAT(p.created_at, '%d-%m-%Y %H:%i') created_at, pc.name, pc.__category_path_names_csv, p.template_id, pc.__url",
