...
domload(() => {
	...
	const d = {
		...
		product_feature_option_ids: [59, 60, 56, 57, 58],
		missing_products_features: [
			{ 1: 59, 2: 56 },
			{ 1: 59, 2: 57 },
			{ 1: 59, 2: 58 },
		...
		features: [
			{
				...
				name: "Kolor",
				options: [
					{ product_feature_option_id: 59, product_feature_id: 1, name: "Czerwony" },
					{ product_feature_option_id: 60, product_feature_id: 1, name: "Beżowy" },
				],
				row_id: 1,
				row_index: 0,
				list_length: 2,
			},
			{
				...
				name: "aaabbbb",
				options: [
					{ product_feature_option_id: 56, product_feature_id: 2, name: "a", row_id: 56, row_index: 0, list_length: 3 },
					{ product_feature_option_id: 57, product_feature_id: 2, name: "b", row_id: 57, row_index: 1, list_length: 3 },
					{ product_feature_option_id: 58, product_feature_id: 2, name: "c", row_id: 58, row_index: 2, list_length: 3 },
				],
				row_id: 2,
				row_index: 1,
				list_length: 2,
