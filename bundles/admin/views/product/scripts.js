...
domload(() => {
	...
	const d = {
		...
		name: "",
		sell_by: "qty",
		product_feature_ids: [1],
		product_feature_option_ids: [59, 60],
		missing_products_features: [{ 1: 59 }, { 1: 60 }],
		features: [
			{
				product_feature_id: 1,
				name: "Kolor",
				options: [
					{ product_feature_option_id: 59, product_feature_id: 1, name: "Czerwony", row_id: 59, row_index: 0, list_length: 2 },
					{ product_feature_option_id: 60, product_feature_id: 1, name: "Beżowy", row_id: 60, row_index: 1, list_length: 2 },
				],
				row_id: 1,
				row_index: 0,
				list_length: 1,
		...
		products_dt: {
			...
			dataset: [{ gross_price: 12.3, net_price: 45.6, product_id: -1, vat: 8, active: 1, is_necessary: false, _row_id: -1001 }],
			label: "Pełna lista produktów",
			selectable: true,
			filters: [],
			sort: false,
			quick_search: "",
			pagination_data: { page_id: 0, row_count: 15, total_rows: 1, page_count: 1 },
			rows: [
				{
					row: { gross_price: 12.3, net_price: 45.6, product_id: -1, vat: 8, active: 1, is_necessary: false, _row_id: -1001 },
					row_id: -1001,
				},
			],
			primary_key: "_row_id",
