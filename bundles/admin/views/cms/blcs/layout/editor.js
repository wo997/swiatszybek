/* js[piep_cms_dependencies] */
{
	...
	piep_cms_manager.registerProp({
		...
		menu_html: html`
			...
			<div class="pretty_radio" data-blc_prop="responsive_settings.width_type" style="--columns:2">
	...
	piep_cms_manager.registerProp({
		...
		menu_html: html` <div class="label">
			...
			<div class="pretty_radio mb2" data-blc_prop="responsive_settings.bind_margins" style="--columns:3">
	...
	piep_cms_manager.registerProp({
		...
		menu_html: html`
			...
			<div class="pretty_radio mb2" data-blc_prop="responsive_settings.bind_paddings" style="--columns:3">
				<div class="checkbox_area" data-tooltip="Wszystkie marginesy są tej samej długości">
					<p-checkbox data-value="all"></p-checkbox>
					<img src="/src/img/bind_all_directions.svg" class="bind_directions_icon" />
				</div>
	...
	piep_cms_manager.registerProp({
		...
		menu_html: html`
			...
			<div class="pretty_radio mb2" data-blc_prop="responsive_settings.bind_borderColors" style="--columns:3">
	...
	piep_cms_manager.registerProp({
		...
		menu_html: html`
			...
			<div class="pretty_radio mb2" data-blc_prop="responsive_settings.bind_borderWidths" style="--columns:3">
