...
foreach ($products["rows"] as $product) {
    $html .= "<div class='product-block' data-product_id='" . $product["general_product_id"] . "'>
        <a href='" . $product["general_product_id"] . "'>
            <img data-src='" . $product["__img_url"] . "' data-height='1w' class='product_image wo997_img' alt=\"\" data-gallery=\""  . "\">
            <h3 class='product-title'><span class='check-tooltip'>" . $product["name"] . "</span></h3>
        </a>
