	...
	return (function (t) {
		...
		function (t, e, s) {
			...
			var n = class {
				...
				find(t, e = !1) {
					...
					for (; i; ) {
						...
						if (
							t < r ||
							(e && t === r && (null == i.next || 0 !== i.next.length()))
						)
							return [i, t];
						(t -= r), (i = s());
					}
				...
				forEachAt(t, e, s) {
					...
					for (; o && n < t + e; ) {
						const i = o.length();
						t > n
							? s(o, t - n, Math.min(e, n + i - t))
							: s(o, 0, Math.min(i, t + e - n)),
							(n += i),
							(o = l());
					}
				}
				...
				query(t, e = r.ANY) {
					...
					if ("string" == typeof t) s = this.types[t] || this.attributes[t];
						...
						(t.getAttribute("class") || "")
							.split(/\s+/)
							.some((t) => !!(s = this.classes[t])),
							(s = s || this.tags[t.tagName]);
					}
					return null == s
						? null
						: e & r.LEVEL & s.scope && e & r.TYPE & s.scope
						? s
						: null;
				}
				register(...t) {
			...
			class c extends u {
				...
				descendant(t, e = 0) {
					...
					return (null == t.blotName && t(s)) ||
						(null != t.blotName && s instanceof t)
						? [s, i]
						: s instanceof c
						? s.descendant(t, i)
						: [null, -1];
			...
			class m extends u {
				...
				position(t, e) {
					let s = Array.from(this.parent.domNode.childNodes).indexOf(
						this.domNode
					);
			...
			class b {
				...
				constructor(t, e, s = {}) {
					...
					(this.scope =
						null != s.scope ? (s.scope & r.LEVEL) | i : r.ATTRIBUTE),
			...
			var v = class extends b {
				...
				value(t) {
					const e = (y(t, this.keyName)[0] || "").slice(
			...
			class w extends d {
				...
				formatAt(t, e, s, i) {
					null != this.scroll.query(s, r.BLOCK)
						? this.format(s, i)
						: super.formatAt(t, e, s, i);
				}
				insertAt(t, e, s) {
					if (null == s || null != this.scroll.query(e, r.INLINE))
			...
			class O extends d {
				...
				optimize(t = [], e = {}) {
					...
					const r = (t, e = !0) => {
						...
						n = (t) => {
							s.has(t.domNode) &&
								(t instanceof d && t.children.forEach(n),
								s.delete(t.domNode),
								t.optimize(e));
						};
					let l = t;
				...
				c = (function () {
					...
					return (
						...
						(t.prototype.push = function (t) {
							...
							if (((t = n.default(!0, {}, t)), "object" == typeof s)) {
								if ("number" == typeof t.delete && "number" == typeof s.delete)
									return (
										(this.ops[e - 1] = { delete: s.delete + t.delete }), this
									);
								if (
						...
						(t.prototype.slice = function (e, s) {
							...
							for (
								var i = [], r = a.default.iterator(this.ops), n = 0;
								n < s && r.hasNext();
						...
						(t.prototype.concat = function (e) {
							...
							return (
								e.ops.length > 0 &&
									(s.push(e.ops[0]), (s.ops = s.ops.concat(e.ops.slice(1)))),
								s
							);
						}),
						(t.prototype.diff = function (e, s) {
							...
							var i = [this, e].map(function (t) {
									return t
										.map(function (s) {
											if (null != s.insert)
												return "string" == typeof s.insert ? s.insert : u;
											throw new Error(
												"diff() called " +
													(t === e ? "on" : "with") +
													" non-document"
										...
										switch (t[0]) {
											...
											case l.default.EQUAL:
												...
												r.default(i.insert, a.insert)
													? n.retain(
															s,
															o.default.diff(i.attributes, a.attributes)
													  )
													: n.push(a).delete(s);
										}
										e -= s;
						...
						(t.prototype.eachLine = function (e, s) {
							void 0 === s && (s = "\n");
							for (
								var i = a.default.iterator(this.ops), r = new t(), n = 0;
								i.hasNext();
						...
						(t.prototype.transformPosition = function (t, e) {
							void 0 === e && (e = !1), (e = !!e);
							for (
								var s = a.default.iterator(this.ops), i = 0;
								s.hasNext() && i <= t;
		...
		function (t, e, s) {
			...
			class h extends n.BlockBlot {
				...
				delta() {
					return (
						null == this.cache.delta && (this.cache.delta = f(this)),
						this.cache.delta
					);
				}
				deleteAt(t, e) {
				...
				insertBefore(t, e) {
					...
					super.insertBefore(t, e),
						s instanceof l.default && s.remove(),
						(this.cache = {});
				}
				length() {
					return (
						null == this.cache.length &&
							(this.cache.length = super.length() + c),
						this.cache.length
					);
				}
				moveChildren(t, e) {
			...
			class d extends n.EmbedBlot {
				attach() {
					super.attach(),
						(this.attributes = new n.AttributorStore(this.domNode));
				}
				delta() {
				...
				insertAt(t, e, s) {
					if ("string" == typeof e && e.endsWith("\n")) {
						...
						this.parent.insertBefore(s, 0 === t ? this : this.next),
							s.insertAt(0, e.slice(0, -1));
			...
			function f(t) {
				return t
					...
					.reduce(
						(t, e) => (0 === e.length() ? t : t.insert(e.value(), p(e))),
						new r.default()
					)
					.insert("\n", p(t));
			}
		...
		function (t, e, s) {
			...
			class y {
				...
				updateContents(t, e = a.default.sources.API) {
					return x.call(
						this,
						() => ((t = new r.default(t)), this.editor.applyDelta(t, e)),
						e,
						!0
					);
				}
		...
		function (t, e, s) {
			...
			class o extends i.InlineBlot {
				...
				formatAt(t, e, s, r) {
					if (
						o.compare(this.statics.blotName, s) < 0 &&
						this.scroll.query(s, i.Scope.BLOT)
					) {
						...
						t === e ||
							(t instanceof Date && e instanceof Date
								...
								: (function (t, e, s) {
										...
										if (n(t))
											return (
												!!n(e) && ((t = i.call(t)), (e = i.call(e)), l(t, e, s))
											);
										if (a(t)) {
											if (!a(e)) return !1;
				...
				(e.default = class {
					...
					getBounds(t, e = 0) {
						...
						return (
							r instanceof Text
								...
								: ((g = o.domNode.getBoundingClientRect()),
								  a > 0 && (b = "right")),
							{
					...
					hasFocus() {
						return (
							...
							h(this.root, document.activeElement)
						);
					}
					normalizedToRange(t) {
					...
					normalizeNative(t) {
						if (
							!h(this.root, t.startContainer) ||
							(!t.collapsed && !h(this.root, t.endContainer))
						)
							return null;
						const e = {
							...
							if (null != t) {
								...
								if (
									...
									"BR" === t.tagName &&
										...
										(t = t.parentNode)),
										"BR" === s.tagName &&
											((i = Array.from(s.parentNode.childNodes).indexOf(s)),
											(s = s.parentNode));
			...
			class n extends i.EmbedBlot {
				...
				restore() {
					...
					if (((o.data = n.CONTENTS), e))
						(u = e),
							(a || i) && (e.insertAt(e.length(), a + l), i && i.remove());
						...
						(function n(a, p) {
							...
							if (Object.getOwnPropertySymbols) {
								...
								for (y = 0; y < x.length; y++) {
									var N = x[y];
									(!(A = Object.getOwnPropertyDescriptor(a, N)) ||
										A.enumerable ||
										c) &&
										((m[N] = n(a[N], p - 1)),
										A.enumerable ||
											Object.defineProperty(m, N, { enumerable: !1 }));
								}
							}
							if (c) {
								...
								for (y = 0; y < E.length; y++) {
									var A,
										q = E[y];
									((A = Object.getOwnPropertyDescriptor(a, q)) &&
										A.enumerable) ||
										((m[q] = n(a[q], p - 1)),
										Object.defineProperty(m, q, { enumerable: !1 }));
								}
							}
							return m;
						})(n, a)
		...
		function (t, e, s) {
			"use strict";
			Object.defineProperty(e, "__esModule", { value: !0 }),
				(e.traverse = e.matchText = e.matchNewline = e.matchBlot = e.matchAttributor = e.default = void 0);
			var i = (function () {
					return function (t, e) {
						if (Array.isArray(t)) return t;
						if (Symbol.iterator in Object(t))
		...
		function (t, e, s) {
			...
			function x(t, e, s, r = !1) {
				...
				if (t instanceof g.default)
					return (0, m.escapeText)(t.value().slice(e, e + s));
				if (t.children) {
			...
			e.default = class {
				...
				getDelta() {
					return this.scroll
						.lines()
						.reduce((t, e) => t.concat(e.delta()), new a.default());
				}
				getFormat(t, e = 0) {
					let s = [],
						r = [];
					0 === e
						? this.scroll.path(t).forEach((t) => {
								...
								e instanceof f.default
									? s.push(e)
									: e instanceof u.LeafBlot && r.push(e);
						  })
						: ((s = this.scroll.lines(t, e)),
						  (r = this.scroll.descendants(u.LeafBlot, t, e)));
					const n = [s, r].map((t) => {
				...
				insertEmbed(t, e, s) {
					return (
						this.scroll.insertAt(t, e, s),
						this.update(new a.default().retain(t).insert({ [e]: s }))
					);
				}
				insertText(t, e, s = {}) {
					return (
				...
				removeFormat(t, e) {
					...
					null != l &&
						...
						(c = l
							...
							.slice(o, o + u - 1)
							.insert("\n")));
					const h = this.getContents(t, e + u).diff(
							new a.default().insert(s).concat(c)
						),
				...
				update(t, e = [], s) {
					...
					if (
						...
						(this.delta = this.getDelta()),
							(t && (0, n.default)(i.compose(t), this.delta)) ||
								(t = i.diff(this.delta, s));
					return t;
				}
			};
		},
			...
			Object.create &&
				...
				(o.prototype.eventNames = function () {
					...
					for (e in (t = this._events))
						s.call(t, e) && r.push(i ? e.slice(1) : e);
				...
				(o.prototype.listeners = function (t) {
					...
					if (!s) return [];
					if (s.fn) return [s.fn];
					for (var r = 0, n = s.length, l = new Array(n); r < n; r++)
						l[r] = s[r].fn;
					return l;
				}),
			...
			class d extends r.ScrollBlot {
				...
				deleteAt(t, e) {
					...
					if ((super.deleteAt(t, e), null != c && n !== c && o > 0)) {
						if (n instanceof l.BlockEmbed || c instanceof l.BlockEmbed)
							return void this.optimize();
						const t =
							c.children.head instanceof a.default ? null : c.children.head;
					...
					const s = (t, e, i) => {
						...
						return (
							t.children.forEachAt(e, i, (t, e, i) => {
								h(t)
									? n.push(t)
									: t instanceof r.ContainerBlot && (n = n.concat(s(t, e, l))),
									(l -= i);
							}),
							n
						);
				...
				optimize(t = [], e = {}) {
					this.batch ||
						(super.optimize(t, e),
						t.length > 0 &&
							this.emitter.emit(n.default.events.SCROLL_OPTIMIZE, t, e));
				}
				path(t) {
				...
				update(t) {
					...
					"string" == typeof t && (e = t),
						...
						t.length > 0 &&
							this.emitter.emit(n.default.events.SCROLL_BEFORE_UPDATE, e, t),
						super.update(t.concat([])),
						t.length > 0 &&
							this.emitter.emit(n.default.events.SCROLL_UPDATE, e, t);
				}
			}
			(d.blotName = "scroll"),
							...
							(null != s.insert
								...
								: null != s.attributes &&
								  Object.keys(s.attributes).some(
										(e) => null != t.query(e, i.Scope.BLOCK)
								  ))
						);
					})(t, e) && (r -= 1),
					r
				...
				listen() {
					this.quill.root.addEventListener("keydown", (t) => {
						...
						var p =
								0 === s.length
									? [d, f]
									: this.quill.getLeaf(s.index + s.length),
							m = i(p, 2);
						const b = m[0],
							y = m[1],
			...
			function v(t) {
				...
				this.quill.deleteText(t, c.default.sources.USER),
					Object.keys(s).length > 0 &&
						this.quill.formatLine(t.index, 1, s, c.default.sources.USER),
					...
					Object.keys(e.format).forEach((t) => {
						null == s[t] &&
							(Array.isArray(e.format[t]) ||
								("link" !== t &&
									this.quill.format(t, e.format[t], c.default.sources.USER)));
					});
			}
			function N(t) {
				return {
				...
				bindings: {
					...
					"code exit": {
						...
						handler(t) {
							...
							for (
								;
								null != o && o.length() <= 1 && o.formats()["code-block"];
		...
		function (t, e, s) {
			...
			(r.blotName = "header"),
				(r.tagName = ["H1", "H2", "H3", "H4", "H5", "H6"]),
				(e.default = r);
		},
		function (t, e, s) {
			"use strict";
			Object.defineProperty(e, "__esModule", { value: !0 }),
				(e.default = e.ListContainer = void 0);
			var i = l(s(3)),
				r = l(s(12)),
				n = l(s(4));
			function l(t) {
		...
		function (t, e, s) {
			...
			class y extends n.default {
				static formats(t, e) {
					for (; null != t && t !== e.domNode; ) {
						if (t.classList.contains(p.default.className))
			...
			class v extends p.default {
				...
				replaceWith(t, e) {
					return (
						this.formatAt(0, this.length(), y.blotName, !1),
							...
							e.diff(n).reduce(
								(t, { retain: e, attributes: s }) =>
									e
										? (s &&
												Object.keys(s).forEach((i) => {
													[v.blotName, y.blotName].includes(i) &&
														this.formatAt(t, e, i, s[i]);
												}),
										  t + e)
										: t,
								0
			...
			class N extends o.default {
				static register() {
					l.default.register(y, !0),
						l.default.register(v, !0),
						l.default.register(x, !0);
				}
				constructor(t, e) {
					...
					this.quill.on(l.default.events.SCROLL_BLOT_MOUNT, (t) => {
						...
						this.options.languages.forEach(({ key: t, label: s }) => {
							...
							null == t.uiNode &&
								(t.attachUI(e),
								t.children.head &&
									(e.value = v.formats(t.children.head.domNode)));
					});
				}
				initTimer() {
					let t = null;
						...
						(0, m.traverse)(
							...
							[
								(t, e) => {
									...
									return s
										? e.compose(
												new i.default().retain(e.length(), { [y.blotName]: s })
										  )
										: e;
								},
							],
		...
		function (t, e, s) {
			...
			class o extends r.default {
				static create(t) {
					const e = super.create();
					return (
						t ? e.setAttribute("data-row", t) : e.setAttribute("data-row", h()),
						e
					);
				}
				static formats(t) {
			...
			class a extends n.default {
				checkMerge() {
					if (super.checkMerge() && null != this.next.children.head) {
						...
						return (
							t.table === e.table && t.table === s.table && t.table === i.table
						);
					}
					return !1;
				}
					...
					t.forEach((t) => {
						new Array(e - t.children.length).fill(0).forEach(() => {
							...
							null != t.children.head &&
								(e = o.formats(t.children.head.domNode));
				...
				attach(t) {
					...
					t.addEventListener(s, (s) => {
						...
						if (null != this.handlers[e]) this.handlers[e].call(this, o);
							...
							this.quill.scroll.query(e).prototype instanceof n.EmbedBlot
						) {
